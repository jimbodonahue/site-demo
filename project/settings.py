...
FIREBASE_CRED_PATH = env('FIREBASE_CRED_PATH', default=BASE_DIR / 'firebase_cred.json')
...
ANALYTICS_TAG_ID = env('GOOGLE_ANALYTICS', default='') # for analytics tag on frontend
...
# # The PAYMENTS app is intentionally disabled while we work on other features.
# # When ready, restore the PAYMENT_VARIANTS block and provide Stripe keys.
